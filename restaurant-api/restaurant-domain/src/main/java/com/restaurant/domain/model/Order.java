...
/**
 * Represents an order in the restaurant domain.
 */
public class Order {
    private String id;
    ...
    public Order(String id, LocalDateTime orderTime, Waiter waiter, List<Food> foodItems, 
                 List<Drink> drinkItems, List<Dessert> dessertItems, String status) {
        this.id = id;
